    ...
    <div class="dash">
        <div class="dash-nav dash-nav-dark">
            ...
            <nav class="dash-nav-list">
                ...
                <div class="dash-nav-dropdown">
                    <a href="addUser.html" class="dash-nav-item"><i class="fas fa-cube"></i> Add User</a>
                </div>
                <div class="dash-nav-dropdown">
                    <a href="addProperty.html" class="dash-nav-item active"><i class="fas fa-file"></i> Add Property</a>
                </div>
            </nav>
        </div>
        <div class="dash-app">
